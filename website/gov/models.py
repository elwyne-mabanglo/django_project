...
class Data(models.Model):
    ...
    # Data Model
    property_name = models.CharField(default="",max_length=1000, blank=False)
    ...
    unit_name = models.CharField(default="",max_length=1000,blank=False)
    tenant_name = models.CharField(default="",max_length=1000,blank=False)
